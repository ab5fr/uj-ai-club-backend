...
pub use admin::{
    admin_create_certificate_multipart, admin_create_challenge, admin_create_notebook_multipart,
    admin_create_resource_multipart, admin_delete_certificate, admin_delete_challenge,
    admin_delete_notebook, admin_delete_resource, admin_get_certificate_by_id,
    admin_get_certificates, admin_get_challenge_by_id, admin_get_challenges,
    admin_get_contact_messages, admin_get_notebook_by_challenge, admin_get_notebook_edit_url,
    ...
    admin_patch_resource_visibility, admin_sync_notebook_to_nbgrader,
